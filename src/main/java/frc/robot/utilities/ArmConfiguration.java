...
public class ArmConfiguration {
    ...
    public ArmConfiguration() {
        ...
        rateLimiter = new SlewRateLimiter(Constants.CollectorArmConstants.RATE_LIMITER);
    ...
    private void configureMotors() {
        configureNEOMotor(liftMotor1, liftMotorConfig, Constants.CollectorArmConstants.CURRENT_LIMIT_NEO);
        configureNEOMotor(liftMotor2, liftMotorConfig, Constants.CollectorArmConstants.CURRENT_LIMIT_NEO);
        configureNEOMotor(pivotMotor1, pivotMotorConfig, Constants.CollectorArmConstants.CURRENT_LIMIT_NEO);
        configureNEOMotor(pivotMotor2, pivotMotorConfig, Constants.CollectorArmConstants.CURRENT_LIMIT_NEO);
        configureNEOMotor(articulateMotor, articulateMotorConfig, Constants.CollectorArmConstants.CURRENT_LIMIT_NEO);
        configureNEOMotor(topIntakeMotor, topIntakeMotorConfig, Constants.CollectorArmConstants.CURRENT_LIMIT_550);
        configureNEOMotor(bottomIntakeMotor, bottomIntakeMotorConfig, Constants.CollectorArmConstants.CURRENT_LIMIT_550);
    ...
    private void configureNEOMotor(SparkMax motor, SparkMaxConfig config, int currentLimit) {
    ...
    private void configure550Motor(SparkMax motor, SparkMaxConfig config, int currentLimit) {
        config.idleMode(IdleMode.kBrake);
        config.smartCurrentLimit(currentLimit);
