...
public class Constants {
    ...
    public static final class ModuleConstants {
        ...
        public static final class FrontLeftModule {
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromRotations(-0.797);
        ...
        public static final class FrontRightModule {
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromRotations(-0.656);
            public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        ...
        public static final class BackLeftModule {
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromRotations(-0.814);
            public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        ...
        public static final class BackRightModule {
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromRotations(-0.677);
            public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
    }
